      ...
      <main>
        ...
        <div className="flex">
          ...
          >
            ...
            >
              ...
              <h2 className="m-5 mt-10 text-2xl font-semibold text-gray-50">
                Summary
              </h2>
        ...
        >
          <div className="col-start-1 col-span-7 flex items-center justify-between">
            ...
            <a
              href="#"
              className="underline text-xl font-basic text-yellow-500"
            >
              See All
            </a>
          </div>
          ...
          >
            ...
            >
              ...
              <h2 id="name" className="mt-14 font-semibold text-gray-50">
                Keythicc Ketik65
              </h2>
              <h1 id="price" className="mt-8 font-light text-gray-50">
                Rp990000
              </h1>
